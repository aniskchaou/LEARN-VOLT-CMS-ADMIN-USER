...
CONTENT;
    ...
    $data['cat']          = 'Courses'; //Category filter
    $data['content']      = <<<CONTENT
        [vc_row full_width="stretch_row_content_no_spaces" el_class="thim-bg-overlay thim-search-light-style" css=".vc_custom_1472061806438{margin-bottom: 80px !important;padding-top: 230px !important;padding-bottom: 200px !important;background-image: url(https://educationwp.thimpress.com/demo-vc-courses-hub/wp-content/uploads/sites/33/2016/08/top-banner.jpg?id=6760) !important;background-position: center !important;background-repeat: no-repeat !important;background-size: cover !important;}"][vc_column][vc_row_inner][vc_column_inner][thim-courses-searching title="Online Courses to Learn" description="Own your future learning new skills online"][/vc_column_inner][/vc_row_inner][vc_raw_html][/vc_raw_html][/vc_column][/vc_row]
CONTENT;
    vc_add_default_templates( $data );
...
CONTENT;
    ...
    $data['cat']          = 'Courses'; //Category filter
    $data['content']      = <<<CONTENT
        [vc_row full_width="stretch_row" css=".vc_custom_1524110766762{padding-top: 100px !important;background-image: url(https://educationwp.thimpress.com/demo-vc-edtech/wp-content/uploads/sites/47/2017/12/bg_instructor_blur.jpg?id=7335) !important;background-position: center !important;background-repeat: no-repeat !important;background-size: cover !important;}"][vc_column][thim-heading title="Instructors" textcolor="#ffffff" size="h2" title_custom="custom" font_size="28" font_weight="normal" clone_title="true" line="" text_align="text-center"][thim-list-instructors visible_item="3" number="3"][/vc_column][/vc_row]
CONTENT;
    vc_add_default_templates( $data );
